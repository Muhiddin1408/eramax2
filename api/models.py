...
class ProductFilial(models.Model):
    ...
    expired_date = models.DateField(blank=True, null=True, default='2022-05-22')
    ...
    def get_quantity(self):
        ...
        return receive_items - faktura_items
...
class Shop(models.Model):
    ...
    dollar_rate = models.PositiveIntegerField()
...
class Yetkazilgantavar(models.Model):
    ...
    measurement = models.CharField(choices=measure, default='dona', max_length=4)
    min_count = models.FloatField(default=0)
    filial = models.ForeignKey(Filial, on_delete=models.CASCADE, related_name='yetkazilgan_product', null=True, blank=True)
    ombor = models.BooleanField(default=False)
    quantity = models.FloatField(default=0)
    image = models.ImageField(upload_to="products/", null=True, blank=True)
    expired_date = models.DateField(blank=True, null=True, default='2022-05-22')
