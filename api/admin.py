...
admin.site.site_header = "Eramax Admin Panel"
admin.site.site_title = "Eramax API"
admin.site.index_title = "Eramax API"
...
admin.site.register(HisobdanChiqarishOmbor)
admin.site.register(Hisobdan_cgiqarish_filial)
admin.site.register(Item)
admin.site.register(YuqFakturaSubmit)
admin.site.register(QaytganProductOmbor)

admin.site.register(FilialExpense)
admin.site.register(FilialExpenseCategory)
...
class ProductFilialAdmin(ExportActionMixin, admin.ModelAdmin):
    list_display = ('id', 'dollar', 'sotish_dollar', 'quantity', 'filial', 'barcode')
...
@admin.register(ReceiveItem)
class ReceiveItemAdmin(admin.ModelAdmin):
    list_display = ('id', 'receive', 'product', 'som', 'dollar', 'kurs', 'quantity')
    search_fields = ('id', 'receive', 'product', 'som', 'dollar', 'kurs', 'quantity')
...
class FakturaItemAdmin(admin.ModelAdmin):
    list_display = ('id', 'faktura', 'product', 'som', 'dollar', 'quantity')
    search_fields = ('id', 'faktura', 'product', 'som', 'dollar', 'quantity')
    list_filter = ('faktura',)
...
class ChangePriceItemAdmin(admin.ModelAdmin):
    list_display = ('id', 'filial', 'old_som', 'old_dollar', 'new_som', 'new_dollar', 'barcode')
    search_fields = ('id', 'filial', 'old_som', 'old_dollar', 'new_som', 'new_dollar', 'barcode')
...
class ChiqimAdmin(admin.ModelAdmin):
    list_display_links = ('id', 'category', 'qancha_som', 'qancha_dol', 'qachon')
    list_display = ('id', 'category', 'qancha_som', 'qancha_dol', 'qachon')
